defmodule DwaFitness.AccountsTest do
  use DwaFitness.DataCase

  alias DwaFitness.Accounts

  describe "users" do
    alias DwaFitness.Accounts.User
  ...
  describe "credentials" do
    alias DwaFitness.Accounts.Credential
